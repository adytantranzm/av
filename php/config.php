<?php
	$conn_string = "host=pgserver1107.postgres.database.azure.com port=5432 dbname=avsdatabase user=avsadmin@pgserver1107 password=avsadmin sslmode=require options='--client_encoding=UTF8'";
